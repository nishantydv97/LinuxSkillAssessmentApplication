...
def create_pod(api_instance,namespace):
    ...
    while ipAllocated==None:
        #print(ipAllocated)
        ipAllocated = read_pod_info(api_instance,"termi-demo")
    print(ipAllocated)
    
def delete_pod(api_instance,namespace,name):
    api_response = api_instance.delete_namespaced_pod_status(name, namespace,body=client.V1DeleteOptions(
            propagation_policy='Foreground',
            grace_period_seconds=5))    
    #pprint(api_response)


def read_pod_info(api_instance,name):
...
def main():
    ...
    #print(read_pod_info(api_instance,"termi-demo"))    
main()
